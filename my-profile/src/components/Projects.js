...
import weadvocacy1 from '../assets/images/weadvocacy1.PNG';
import weadvocacy2 from '../assets/images/weadvocacy2.PNG';
import weadvocacy3 from '../assets/images/weadvocacy3.PNG';
            ...
            <MDBRow className="mt-5">
                ...
                <MDBCol lg="6" md="12" sm="12" xs="12" className="d-flex">
                    <MDBContainer className="align-self-center project-description">
                        ...
                        <p className="h4 lead">
                            A social media like app created for WeAdvocacy
                        </p>
                        <p className="h6 font-weight-bold"> 
